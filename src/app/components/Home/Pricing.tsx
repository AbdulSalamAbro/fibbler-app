            ...
            <ul className="flex-1 flex flex-col gap-[8px]">
              ...
              <li className="text-[16px] font-[700] leading-[134%] satoshifont-500 text-[#181127] flex items-center gap-[8px]">
                ...
                <span
                  ...
                  className="inline-flex items-center justify-center w-4 h-4 rounded-full border border-[#181127] ml-1 cursor-help"
                >
                ...
                <Tooltip
                  id="webhook-tooltip"
                  place="top"
                  content="Maximum 3 webhooks can be active at the same time"
                  className="text-sm z-[9999] max-w-[300px]"
                />
              </li>
              <li className="text-[16px] font-[700] leading-[134%] satoshifont-500 text-[#181127] flex items-center gap-[8px]">
                <div className="w-[14px]">
                ...
                <Tooltip
                  id="campaign-tooltip"
                  place="top"
                  content="Maximum 3 campaign schedules can be active at the same time"
                  className="text-sm z-[9999] max-w-[300px]"
                />
              </li>
          ...
          <div className="relative md:border-[5px] border-[4px] border-[#181127] rounded-[20px] bg-[#fcfbfd] xl:px-[32px] lg:px-[20px] px-[25px] lg:pb-[20px] pb-[25px] xl:pt-[34px] lg:pt-[24px] pt-[30px] flex flex-col h-full">
            ...
            <div className="min-h-[100px]">
              ...
              <p className="xl:text-[16px] sm:text-[14px] text-[16px] satoshifont-500 font-[500] leading-[150%] text-[#000] mt-[14px] mb-[60px]">
                Perfect for teams looking to take their LinkedIn Ads efforts to
                the next level.
              </p>
            </div>
          ...
          <div className="relative md:border-[5px] border-[4px] border-[#181127] rounded-[20px] bg-[#fcfbfd] xl:px-[32px] lg:px-[20px] px-[25px] lg:pb-[20px] pb-[25px] xl:pt-[34px] lg:pt-[24px] pt-[30px] flex flex-col h-full">
            ...
            <div className="mb-[43px]">
              ...
              <Link
                ...
                className="text-[#fff] bg-[#111827] rounded-[18px] border-[8px] border-[#adb4c2] xl:py-[20px] py-[15px] md:py-[10px] xl:text-[18px] text-[18px] md:text-[15px] leading-normal font-[900] tracking-normal flex items-center gap-[10px] inter-font justify-center w-full hover:gap-[20px] hover:pl-[10px] transition-all duration-100 ease-in-out try-btn-340px"
              >
            ...
            <ul className="flex-1 flex flex-col gap-[8px]">
              ...
              <li className="text-[16px] font-[700] leading-[134%] satoshifont-500 text-[#181127] flex items-center gap-[8px]">
                ...
                <Tooltip
                  id="accounts-tooltip"
                  place="top"
                  content="Add more accounts for a fee that decreases as the number of accounts increases. Read more in our FAQ below."
                  className="text-sm z-[9999] max-w-[300px]"
                />
              </li>
              <li className="text-[16px] font-[700] leading-[134%] satoshifont-500 text-[#181127] flex items-center gap-[8px]">
